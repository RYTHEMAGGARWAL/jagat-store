...
{
  name: 'Jagat Store Bringraj powder',
  weight: '100g',
  price: 75,
  oldPrice: 110,
  discount: '32% OFF',
  category: "Jagat Store",
  brand: 'Jagat Store',
  image: '	https://tse3.mm.bing.net/th/id/OIP.nxF3G_hYHAPV-5RXoHQnjwHaDY?pid=Api&P=0&h=180',
  inStock: true,
...
{
    name: 'Jagat Store Hudda Hing sabut',
    weight: '8g',
    price: 390,
    oldPrice: 460,
    discount: '15% OFF',
...
{
    name: 'Jagat Store Hudda Hing powder',
    weight: '50g',
    price: 176,
    oldPrice: 220,
    discount: '20% OFF',
...
// Sabudana - Chota Dana (Small)
{
    name: 'Jagat Store Sabudana Chota Dana',
    weight: '250g',
    price: 35,
    oldPrice: 48,
    discount: '27% OFF',
    category: 'Jagat Store',
    brand: 'Jagat Store',
    image: '	https://tse2.mm.bing.net/th/id/OIP.5vF9UOVQzSwKD9dF8DxnCAHaHa?pid=Api&P=0&h=180',
    inStock: true,
    description: '🏪 Jagat Store | Sabudana Chota Dana | Small Pearl | Premium Quality | Perfect for Kheer & Khichdi | 250g Pack',
    stock: 100
},

// Sabudana - Medium Dana
{
    name: 'Jagat Store Sabudana Medium Dana',
    weight: '250g',
    price: 30,
    oldPrice: 40,
    discount: '25% OFF',
    category: 'Jagat Store',
    brand: 'Jagat Store',
    image: '	https://tse3.mm.bing.net/th/id/OIP.-OFc21WXs8WSHPL3UlUnuAHaFj?pid=Api&P=0&h=180',
    inStock: true,
    description: '🏪 Jagat Store | Sabudana Medium Dana | Medium Pearl | Premium Quality | Ideal for Vada & Khichdi | 250g Pack',
    stock: 120
},

// Sabudana - Bada Dana (Large)
{
    name: 'Jagat Store Sabudana Bada Dana',
    weight: '250g',
    price: 35,
    oldPrice: 48,
    discount: '27% OFF',
    category: 'Jagat Store',
    brand: 'Jagat Store',
    image: '	https://tse1.mm.bing.net/th/id/OIP.9h5tYubnQv0GvOQtamvCbAHaHa?pid=Api&H=160&W=160',
    inStock: true,
    description: '🏪 Jagat Store | Sabudana Bada Dana | Large Pearl | Premium Quality | Best for Vrat & Fasting | 250g Pack',
    stock: 90
}
